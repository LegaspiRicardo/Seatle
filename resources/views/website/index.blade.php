...
@section('titulo', 'Escuela de Natación')
      ...
      <!-------------------  -----Imagen-Inicio y C2A-------------------------------------------->
        ...
        <div class="col-12 mx-auto p-0 contenedor-imagen-texto">
          ...
          <div class="texto-imagen-texto">
            <h1 class="col mx-auto"> ¡Aprende a nadar con nosotros!</h1>
            <p class="p-header">Clases de natación grupales y personalizadas </p>
            <h3 class="col-3 pl-2 mx-auto pt-2 pb-2"><a href="" class="link-informes"> Informes  </a> </h3>
          </div>
      </div>
      <!--------------------------Clases para niños--------------------------------------------->
      <div class="clases">
        ...
        <div class="tipos-clases">
          <div class="particular">
            <a href="{{ route('clases-ninos') }}"><h5 class="pb-1">Particulares</h5></a>
          ...
          <div class="grupal">
            <a href="{{ route('clases-ninos') }}"><h5 class="pb-1">Grupales</h5></a>
            <ul class="lista-clases">
      ...
      <div class="clases">
            ...
            <div class="tipos-clases">
              <div class="grupal-adulto">
                <a href="{{ route('clases-adultos') }}"><h5 class="pb-1">Grupales</h5></a>
                <ul class="lista-clases">
        ...
        <div class="d-none d-sm-block">
          <ul class="row pt-2 pb-3 mx-auto ">
            <div class="col-6">
              ...
              <li class="col"><img src="front_end/PNGs/guion.png" class="palomita" alt="">Area común.</li>
              </div>
              <div class="col-6">
