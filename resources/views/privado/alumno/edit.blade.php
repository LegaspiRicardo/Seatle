        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="needs-validation" novalidate action="/alumnos/{{$alumno->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row mt-1">
                            <div class="col-4  mt-3">
                                ...
                                <input type="date" class="form-control mt-2 inputForm" id="validationCustom03" name="fecha_nac" value="{{$alumno->fecha_nac}}" required>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                <input type="text" class="form-control inputForm" id="validationCustom03" name="nivel" value="{{$alumno->nivel}}">
