...
<div class="row d-none d-d-lg-block d-xl-flex">
...
<div class="row col-11 ml-auto d-none d-md-block d-xl-none d-sm-block ">
  <div class="row ">
    @foreach ($alumnos as $alumno)
    <div class=" col-6 d-inline ">
      <div class="card col-6 mt-3 mx-0 ">
        <!-- --------Medium screen size card body -------------->
        <div class="card-body d-none d-md-block d-xl-none px-1">
          <div class="row mb-2 text-center">
            ...
            <div class="col-7 mb-1 ml-auto p-0 text-start">
          ...
          <div class="row p-0 mx-auto ">
            ...
            <ul class="p-0 col-9 text-start">
              <!---------------- Crear un for each para cada clase particular asignada al alumno---------->
              <li class="mb-0 col-10 p-0 text-left">Lu. 4:00 - 4:30 </li>
              <li class="mb-0 col-10 p-0 text-left">Mie. 5:00 - 5:30 </li>
              <li class="mb-0 col-10 p-0 text-left">Sab. 10:00 - 10:30</li>
            </ul>
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide col-12  ">
        <div class="card col-12 mx-auto">
          ...
          <div class="card-body d-block d-sm-none mb-3 px-1">
            <div class="row mb-2 text-center">
