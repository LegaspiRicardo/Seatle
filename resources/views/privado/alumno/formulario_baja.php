        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h3 class="modal-title mx-auto" id="exampleModalLabel">Dar de baja Alumno</h3>
                    ...
                    <form class="needs-validation" novalidate action="../../../../back_end/controladores/alumno_controlador.php" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-3 styled-select mx-auto black rounded ">
                                <select name="status" class="form-control" value="Baja" >
                                    <option value="Baja" selected hidden>Baja </option>
                                </select>
                ...
                <div class="modal-footer">
                    <input type="submit" class="col-8 btn-baja mx-auto pt-1 pb-1" value="Dar de baja">
