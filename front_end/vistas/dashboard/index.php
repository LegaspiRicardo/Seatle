...
<h3 class=" col-6 mx-auto p-2 titulo_pasos">Pasos para registrar alumnos</h3>
  <div class="row ">
          <div class="col-3 mx-auto paso_tutor">
            <h5 class="subtitulo_pasos ">Primer paso</h5>
            
            <h2 class="titulo_pasos ">1</h2>
            <?php 
          ...
          <div class="col-3 mx-auto paso_alumno">
            <h5 class="subtitulo_pasos ">Segundo paso</h5>
            
            <h2 class="titulo_pasos ">2</h2>
            <?php 
