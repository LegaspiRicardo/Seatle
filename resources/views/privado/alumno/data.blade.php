      ...
      <div class="swiper-slide">
        <div class="card col-6 mt-3 mx-auto">
          ...
          <div class="card-body d-block d-sm-none">
            <div class="row mb-2 text-center">
              <div class="col-12 mx-auto d-xl-none bg-danger">
                <img src="/admin/files/alumnos/{{$alumno->img}}" alt="" class="imagen text-center p-0">
              </div>


              <div class="col-10 mb-1 p-0">
                <h5 class="card-title pb-0 text-start"> {{$alumno->nombres}} {{$alumno->apellido_pat}} {{$alumno->apellido_mat}}</h5>
                <p class="mb-0"># <b>{{$alumno->id}}</b></p>
              </div>
            </div>
