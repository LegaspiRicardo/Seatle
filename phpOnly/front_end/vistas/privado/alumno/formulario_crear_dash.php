...
<button type="button" class="btn btn_alumno " data-toggle="modal" data-target="#exampleModal4">
    Registrar alumno
</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="needs-validation" novalidate action="../../../../back_end/controladores/alumno_controlador.php" method="POST">
